...
from methods.predict import PredictGradOutputFixedForm, PredictGradOutputGeneralForm,\
    PredictGradOutputFixedFormWithConfusion, PredictGradOutputGeneralFormUseLabel
